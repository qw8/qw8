...
谷歌的Chrome浏览器就有这种开箱即用的功能。只需转到查看>开发人员>开发人员工具，并在最近的版本中打开Sources选项卡，然后打开命令菜单。然后，点击Coverage，在Coverage analysis窗口中高亮显示当前页面上未使用的代码。 ![unused-css.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9cd9fde5bfc14682b1028b85292acb11~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp?)
...
具体回流与重绘知识点可以看我这篇文章：[介绍回流与重绘（Reflow & Repaint），以及如何进行优化?](https://juejin.cn/post/7064077572132323365)


原文链接：https://juejin.cn/post/7077347573740077069
...
可以使用多个 HTML 中的``标签来代替 @import，它将并行加载 CSS 文件，可以在一定程度上提高应用的加载的速度。
...
[原文](https://mp.weixin.qq.com/s/3XLXzvq83isH2lSTHCKkVA)