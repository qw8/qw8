...
![1.png](../../images/virtual_dom1.png?raw=true)
...
![12.png](../../images/virtual_dom1_2.png?raw=true) 
...
![2.png](../../images/virtual_dom2.png?raw=true) 
...
![3.png](../../images/virtual_dom3.png?raw=true)  

**（1）深度优先遍历，记录差异**

在实际的代码中，会对新旧两棵树进行一个深度优先的遍历，这样每个节点都会有一个唯一的标记： 

![4.png](../../images/virtual_dom4.png?raw=true)   
...
![5.png](../../images/virtual_dom5.png?raw=true) 

 示例：字符串 `a` 和 `b`，`a=“abcde” ，b=“cabef”`，根据上面给出的计算公式，则他们的 `Levenshtein Distance` 的计算过程如下：

![6.png](../../images/virtual_dom6.png?raw=true) 
...
![7](../../images/virtual_dom7.png?raw=true)  
...
![8.png](../../images/virtual_dom8.png?raw=true)     
...
- 比较两棵虚拟 `DOM` 树的差异 — `diff.js`
  ...
  ![9.png](../../images/virtual_dom9.png?raw=true)  
...
![10.png](../../images/virtual_dom10.png?raw=true)  
...
![11.jpg](../../images/virtual_dom11.jpg?raw=true)    
...
![12.jpg](../../images/virtual_dom12.jpg?raw=true)  
...
![13.jpg](../../images/virtual_dom13.jpg?raw=true)  

（2.4）第四轮的 `diff `中，过程同步骤3； 

![14.jpg](../../images/virtual_dom14.jpg?raw=true)  

  （2.5）第五轮的 `diff` 中，同过程1； 

![15.jpg](../../images/virtual_dom15.jpg?raw=true)   

（2.6）遍历的过程结束后，`newStartIdx > newEndIdx`，说明此时 `oldCh` 存在多余的节点，那么最后就需要将这些多余的节点删除。 

![16g](../../images/virtual_dom16.jpg?raw=true)  
...
![17.jpg](../../images/virtual_dom17.jpg?raw=true)   
...
![18.jpg](../../images/virtual_dom18.jpg?raw=true)  
...
![19.jpg](../../images/virtual_dom19.jpg?raw=true)  

（3.4）第四轮的`diff`中，过程同步骤2； 

![20.jpg](../../images/virtual_dom20.jpg?raw=true) 

  （3.5）第五轮的`diff`中，因为此时 `oldStartIndex` 已经大于 `oldEndIndex`，所以将剩余的 `Vnode` 队列插入队列最后。

![21.jpg](../../images/virtual_dom21.jpg?raw=true)   
...
![22.png](../../images/virtual_dom22.png?raw=true)  
